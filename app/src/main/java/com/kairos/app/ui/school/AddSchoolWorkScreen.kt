...
@Composable
fun AddSchoolWorkScreen(parentEntry: NavBackStackEntry?, onClose: () -> Unit) {
    ...
    Scaffold(
        ...
        Column(
            ...
            Button(
                onClick = {
                    vm.add(personId, title.trim(), typeKey, dueDate, subject.trim().ifBlank { null }, classId.ifBlank { null })
                    onClose()
                },
